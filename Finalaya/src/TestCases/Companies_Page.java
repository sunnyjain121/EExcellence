...
public class Companies_Page {
	...
	// This method would be run before each method present in test case file & will launch browser & will open application.
		...
		public void Companies_VerifyNavigationOnCompaniesSubtab() throws Exception
		{
			...
			obj_companiesPage.verifyInformationTab();
			
			//Verify Document  Tab Is Present
			LoggerInstance.logger.info("Verify Document Tab Is Displayed on Page.");
			obj_companiesPage.verifyDocumentTabIsDisplayed();
			...
			obj_companiesPage.VerifyComanyNameSortedAscending();
			...
			obj_companiesPage.VerifyComanyNameSorteDecendingOrder();
			...
			obj_companiesPage.VerifyComanyTableHeadingIsDisplayed();
			...
			obj_companiesPage.VerifyToolTipCompanyValIndustryColumnValMatches();
	       ...
	       //Verify BSE Text red color have down arrow and green color text have up arrow
			...
			obj_companiesPage.VerifyBSEArrowColorTextVal();
			...
			obj_companiesPage.verifyClickingNextPreviousDislayedPage();
